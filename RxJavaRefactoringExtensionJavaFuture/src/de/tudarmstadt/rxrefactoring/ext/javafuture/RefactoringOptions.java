...
/**
 * For now: This defines what refactoring processes should be done by this extension.
 * We can refactor Future or FutureTask.
 * 
 * Futures were no cancel, etc. is used can be refactored using the simple Future workers.
 * Additionally we support a special FutureWrapper.
 * 
