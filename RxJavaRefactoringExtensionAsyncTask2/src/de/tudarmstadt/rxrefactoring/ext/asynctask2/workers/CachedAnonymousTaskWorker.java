...
import de.tudarmstadt.rxrefactoring.ext.asynctask2.builders.ComplexObservableBuilder;
import de.tudarmstadt.rxrefactoring.ext.asynctask2.builders.ObservableBuilder;
import de.tudarmstadt.rxrefactoring.ext.asynctask2.builders.SubscriberHolder;
import de.tudarmstadt.rxrefactoring.ext.asynctask2.collect.AsyncTaskCollector;
import de.tudarmstadt.rxrefactoring.ext.asynctask2.domain.SchedulerType;
import de.tudarmstadt.rxrefactoring.ext.asynctask2.utils.AsyncTaskAstUtils;
import de.tudarmstadt.rxrefactoring.ext.asynctask2.writers.UnitWriterExt;
...
public class CachedAnonymousTaskWorker extends AbstractRefactorWorker<AsyncTaskCollector>
{
	...
	private void updateonPreExecute( AnonymousClassDeclaration asyncTaskDeclaration,
			UnitWriterExt singleChangeWriter, AST ast, AsyncTaskVisitor asyncTaskVisitor )
	{
			...
			SubscriberHolder subscriberHolder )
	{
		...
		ObservableBuilder complexObservable = ObservableBuilder.newObservable( type, doInBackgroundBlock, SchedulerType.JAVA_MAIN_THREAD )
