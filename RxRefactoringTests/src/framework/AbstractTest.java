...
public abstract class AbstractTest
{
	...
	/**
	 * This method can be used to compare to source codes without considering
	 * line breaks
	 * 
	 * @param expectedSourceCode
	 *            expected source code
	 * @param actualSourceCode
	 *            actual source code
	 */
	...
	/**
	 * Compares all compilation units in result with the target file and returns
	 * its source code
	 * 
	 * @param targetFile
	 *            target file
	 * @param results
	 *            map containing results
