...
public class InstantiationCollector implements IWorker<Map<ASTNode, UseDef>, InstantiationCollector> {
	...
	// List of method names (e.g. "get") which, if set, define which methods can be
	// implemented
	// by a subclass for that subclass to be stored in subclassDeclarations. If the
	// subclass declares any
	// additional methods or fields, or the parameter types are not valid, it is not
	// stored.
	...
	public class FutureInstantiationVisitor extends UnitASTVisitor {
		 ...
		 * {@link InstantiationCollector#subclassesFuture} and indirectly in
		 * {@link InstantiationCollector#indirectSubclassesFuture}. The maps are
		 * disjoint.
		 */
		@Override
		 ...
		 * {@link InstantiationCollector#methodInvocationsReturnFuture} and invocations
		 * that return collections of them (implement {@link java.util.Collection}) in
		 * {@link InstantiationCollector#methodInvocationsReturnFutureColl}
		 */
		@Override
	...
	/**
	 * Checks if the class only implements the allowed methods and declares no
	 * additional fields.
	 */
