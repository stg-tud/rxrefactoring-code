...
public final class RefactoringUtils {
	...
	/**
	 * Returns a string where the char sequence "swingworker" or "worker" was
	 * replaced by rxObservable. Example:<br>
	 * <ul>
	 ...
	 * 
	 * @param text
	 *            string containing the char sequence "swingworker" (case
	 *            insensitive)
	...
	/**
	 * Uses {@link SwingWorkerInfo} to determine the method name to be used after
	 * refactoring. If no name for methodName is found in {@link SwingWorkerInfo},
