...
import de.tudarmstadt.rxrefactoring.ext.swingworker.extensions.SwingWorkerOnlyTypeDeclExtension;
 ...
 * Created: 18/01/2018
 */
public class SwingWorkerOnlyTypeDeclHandler extends RefactoringE4Handler {
	
		@Override
		public @NonNull IRefactorExtension createExtension() {
			return new SwingWorkerOnlyTypeDeclExtension();
		}
