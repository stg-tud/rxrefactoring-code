...
public class SwingWorkerWrapper extends ASTVisitor {
	...
	public SwingWorkerWrapper() {
		...
		suscriberMethodNames = Arrays.asList("add", "isUnsubscribed", "onStart", "request", "setProducer",
				"unsubscribe");
	...
	public boolean hasAdditionalFieldsOrMethods() {
		return !fieldDeclarations.isEmpty() || !additionalMethodDeclarations.isEmpty() || !typeDeclarations.isEmpty();
	}
