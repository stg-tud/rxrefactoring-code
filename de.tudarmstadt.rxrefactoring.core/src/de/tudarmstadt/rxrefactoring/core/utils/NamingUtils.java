...
public class NamingUtils {
	...
	public final static WorkerIdentifier ARRAY_CREATION_IDENTIFIER = new WorkerIdentifier("Array Creations");
	public final static WorkerIdentifier RETURN_STATEMENT_IDENTIFIER = new WorkerIdentifier("Return Statements");
